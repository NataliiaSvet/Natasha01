...
plt.figure(figsize=(3, 1,5))  # Установка размера графика
...
# Добавление текста под таблицей
st.markdown("""<div style='text-align: left; font-weight: bold; font-size: 16px;'>
По текущим данным Министерства внутренних дел Ческой республики, в данный момент в стране находится более 379 тысяч беженцев из Украины с временной защитой всех возрастных категорий, включая детей и стариков.</div>""", unsafe_allow_html=True)
