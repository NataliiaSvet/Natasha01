...
st.markdown("<h1 style='text-align: center; color: black;'>Отрасли экономики Чешской республики, в которых работают мигранты из Украины с временной защитой</h1>", unsafe_allow_html=True)
